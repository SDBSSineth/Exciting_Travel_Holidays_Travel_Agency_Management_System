...
app.use(fileUpload({
    limits: { fileSize: 50 * 1024 * 1024 }, // Adjust file size limit as needed
}));
...
const bookingRoutes = require("./routes/tourguidebooking.js"); // Import booking routes
app.use("/tourguidebooking", bookingRoutes); // Register the route
